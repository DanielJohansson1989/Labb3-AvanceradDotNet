    ...
    public partial class Initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonalInterestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonId = table.Column<int>(type: "int", nullable: false),
                    InterestId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PersonalInterest_Interests_InterestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Links_PersonalInterest_PersonalInterestId",
                        column: x => x.PersonalInterestId,
                        principalTable: "PersonalInterest",
                        principalColumn: "PersonalInterestId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Sailing is a recreational or competitive activity that involves navigating a watercraft, typically a sailboat, across bodies of water using the power of the wind. Sailboats are equipped with sails, which harness the wind's force to propel the vessel forward. Sailors adjust the sails and steer the boat to catch the wind effectively and control its direction.", "Sailing" },
                    { 5, "Programming is the art and science of instructing computers to perform specific tasks by writing sets of instructions, known as code, in various programming languages. It involves problem-solving, logical thinking, and creativity to design, develop, and debug software applications, websites, and digital systems. Programmers use their expertise to automate processes, create innovative solutions, and shape the digital world we interact with every day.", "Programming" },
                    { 6, "Fishing is a recreational or commercial activity involving the pursuit and capture of aquatic life, typically fish, using various techniques such as angling, netting, or trapping. Anglers often employ rods, reels, and bait to lure fish, while commercial fishermen use specialized equipment like trawlers or longlines to catch fish in larger quantities. It's a timeless pastime enjoyed for relaxation, challenge, and sustenance, connecting individuals with nature and the bounty of the sea or freshwater environments.", "Fishing" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PersonalInterestId", "InterestId", "PersonId" },
                values: new object[,]
                {
                    { 1, 1, 1 },
                    { 2, 2, 1 },
            ...
            migrationBuilder.InsertData(
                table: "Links",
                columns: new[] { "LinkId", "PersonalInterestId", "URL" },
                values: new object[,]
                {
                    { 1, 1, "skidresor.se" },
                    { 2, 1, "skistar.com" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Links_PersonalInterestId",
                table: "Links",
                column: "PersonalInterestId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalInterest_InterestId",
                table: "PersonalInterest",
                column: "InterestId");
